...
public class ToastUtils {
    ...
    private static int yOffset =
            (int) (64 * KittApplication.getApplication().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) KittApplication.getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private static void show(@StringRes int resId, int duration) {
        show(KittApplication.getApplication().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(KittApplication.getApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        cancel();
        if (customView != null) {
            sToast = new Toast(KittApplication.getApplication());
            ...
            sToast = Toast.makeText(KittApplication.getApplication(), text, duration);
        }
