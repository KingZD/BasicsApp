...
public class SwitchButtonView extends View {
    ...
    public SwitchButtonView(Context context, AttributeSet attrs) {
        ...
        colorPrimary = a.getColor(R.styleable.SwitchButtonView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.SwitchButtonView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorOff = a.getColor(R.styleable.SwitchButtonView_offColor, 0xFFE3E3E3);
        colorOffDark = a.getColor(R.styleable.SwitchButtonView_offColorDark, 0xFFBFBFBF);
        colorShadow = a.getColor(R.styleable.SwitchButtonView_shadowColor, 0xFF333333);
        ratioAspect = a.getFloat(R.styleable.SwitchButtonView_ratioAspect, 0.68f);
        hasShadow = a.getBoolean(R.styleable.SwitchButtonView_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.SwitchButtonView_isOpened, false);
    ...
    public interface OnStateChangedListener {
        void toggleToOn(SwitchButtonView view);

        void toggleToOff(SwitchButtonView view);
    }
