...
public class RegisterSelectorDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText(ResourceUtils.getString(getActivity(), "account_choose_register_style"));
        ...
        btnPhone.setText(ResourceUtils.getString(getActivity(), "account_phone_register"));
        btnPhone.setOnClickListener(onClickListener);
        TextView btnMail = view.findViewById(R.id.btn_register_email);
        btnMail.setText(ResourceUtils.getString(getActivity(), "ali_sdk_openaccount_text_email_register"));
