...
public abstract class JmDNS
{
     ...
     */
    public static JmDNS create(InetAddress addr, String hostname) throws IOException
    {
        return new JmDNSImpl(addr, hostname);
    }
    ...
    /**
     * Register a service. The service is registered for access by other javax.jmdns clients.
    ...
    /**
     * Close down javax.jmdns. Release all resources and unregister all services.
     */
